...
export default function EditStoryStep2() {
  ...
  const handleSubmit = async () => {
    ...
    let finalData = { title, tags, isAnonymous, authorName, content, contentHtml };
    if (typeof window !== 'undefined') {
      const saved = localStorage.getItem('editStoryData');
      if (saved) {
        try {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900">Story Updated Successfully!</h3>
          <p className="mt-2 text-sm text-gray-500">
            Your story has been updated and submitted for review. You'll receive a notification once it's approved.
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          {/* Removed draft saved message - not needed for direct story editing */}
          {/* Header */}
          <div className="mb-8">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Edit Your Story</h1>
                <p className="mt-2 text-gray-600">
                  Update your personal experience or community story
                </p>
              </div>
              <button
                onClick={() => {
            ...
            {/* Removed manual save warning - not needed for direct story editing */}
          </div>
