...
export default function BlogNotFound() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 py-20">
      <div className="h-16 w-16 rounded-2xl bg-indigo-50 text-indigo-600 flex items-center justify-center mb-6">
      ...
      <p className="text-slate-500 font-medium text-center max-w-md mb-8">
        Axtardığınız bloq mövcud deyil, silinmiş və ya hələ dərc edilməmiş ola bilər.
      </p>
      <Link
        href="/blogs"
