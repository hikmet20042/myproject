...
//     title: `${vacancy.title} — icma360`,
//     description: vacancy.description.substring(0, 160),
//     keywords: [...azerbaijanKeywords, vacancy.type, vacancy.city],
//     canonical: `/resources/vacancies/${vacancy.slug}`,
//     ogImage: vacancy.imageUrl || '/opengraph-image',
//     ogType: 'article',
