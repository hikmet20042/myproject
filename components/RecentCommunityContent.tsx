			...
			<div className="section-padding">
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-8">
						<h2 className="text-3xl lg:text-4xl font-bold text-primary">{t('recentCommunity.title')}</h2>
						<p className="text-gray-600 mt-2">{t('recentCommunity.subtitle')}</p>
					</div>
					{loading && (
					...
					{!loading && allContent.length > 0 ? (
						...
						<p className="text-gray-600 text-lg font-medium mb-2">{t('recentCommunity.emptyTitle')}</p>
						<p className="text-gray-500 text-sm">{t('recentCommunity.emptyBody')}</p>
							</div>
						</div>
					)}
					...
					<div className="text-center mt-8 space-y-4">
						<div className="flex flex-col sm:flex-row gap-4 justify-center">
							<Link href={localePath('/blogs')} className="btn-secondary border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white">
								{t('recentCommunity.viewAll')}
							</Link>
