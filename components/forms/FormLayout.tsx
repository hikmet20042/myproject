...
export default function FormLayout({
  ...
  return (
    <div className="relative min-h-screen bg-background py-8 sm:py-12 text-foreground transition-colors duration-200">
      <div className="absolute inset-0 bg-[linear-gradient(to_right,var(--border)_1px,transparent_1px),linear-gradient(to_bottom,var(--border)_1px,transparent_1px)] bg-[size:4rem_4rem] opacity-35" />
